    ...
    <>
      ...
      >
        ...
        <div className="px-4 py-3 border-t border-slate-200 bg-slate-50">
          <Link
            to="/settings/rubric"
            className="flex items-center justify-center gap-2 w-full py-2 mb-2 text-sm text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-colors"
          >
